                ...
                <div id="nav-tab-card" class="tab-pane fade show active">
                  ...
                  <form role="form" action="{{route('product.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="editor" placeholder="Enter here" name="description"></textarea>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="textarea" name="content" id="cnt" placeholder="Enter here" required class="form-control">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="price" id="price" placeholder="Enter here" required class="form-control">
                      </div>
