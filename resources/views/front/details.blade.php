...
<div class="banner-wrapper no_background">
    <div class="banner-wrapper-inner">
        <nav class="kobolg-breadcrumb container"><a href="{{route('front.home')}}">Home</a>
                        ...
                        <div class="contain-left has-gallery">
                            ...
                            <div class="summary entry-summary">
                                ...
                                <p class="price"><span class="kobolg-Price-amount amount"><span
                                        class="kobolg-Price-currencySymbol"></span>Price: {{number_format($item->price)}} VNĐ</span></p>
                                <p class="">
                                    Trạng thái: <span> {!!

                                        $item->status ==1 ?
                                        '<span class="badge bg-primary" style="color:white">Còn hàng</span>' :
                                        '<span class="badge bg-secondary" style="color:white>Hết bố nó hàng</span>'

                                        !!}</span>
                                </p>
                                <p class="stock in-stock">
                                    Nội dung: <span> {{$item->content}}</span>
                                </p>
                                <div class="">
                        ...
                        <div class="kobolg-Tabs-panel kobolg-Tabs-panel--description panel entry-content kobolg-tab"
                            ...
                            <div class="container-table">
                                <div class="container-cell">
                                    <h2 class="az_custom_heading">{!!$item->description!!}</h2>
                                ...
                                <a class="thumb-link"
                                   href="#" tabindex="0">
                                    <img class="img-responsive"
                                         src="{{asset('assets/images/apro101-1-600x778.jpg')}}"
            ...
            {{-- <div class="col-md-12 col-sm-12 kobolg_dreaming_upsell-product">
                ...
                <div class="owl-slick owl-products equal-container better-height"
                    ...
                    <div class="product-item style-01 post-37 product type-product status-publish has-post-thumbnail product_cat-chair product_cat-bed product_tag-light product_tag-hat product_tag-sock first instock shipping-taxable purchasable product-type-simple  ">
                        <div class="product-inner tooltip-left">
                            <div class="product-thumb">
                                <a class="thumb-link kobolg-product-gallery__image"
                                   href="#"
                                   tabindex="0">
