                ...
                <div class="card-body p-4 p-lg-5 text-black">
                  ...
                  <form action="{{ route('get.login') }}" method="POST">
                    ...
                    <div class="form-outline mb-4">
                      ...
                      <input type="email" name="email" value="{{Session::get('verifiedEmail') ? Session::get('verifiedEmail') : old('email')}}" id="form2Example17" class="form-control form-control-lg" />
                    </div>
                    ...
                    <div class="checkbox">
                        <label for="">
                            <input type="checkbox" value="remember"> Remember login
                        </label>
                    </div>
