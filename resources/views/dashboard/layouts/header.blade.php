            ...
            <div class="header-middle-inner">
                <div class="header-logo-menu">
                    ...
                    <div class="header-logo">
                        <a href="{{route('dashboard.home')}}"><img alt="Kobolg" height="50px" width="200px" src="{{asset('assets/images/logo2.png')}}"
                                                  class="logo"></a></div>
                </div>
                                ...
                                <ul id="menu-vertical-menu" class="azeroth-nav vertical-menu default">
                                    <li id="menu-item-886"
                                        class="menu-item menu-item-type-custom menu-item-object-custom menu-item-886"><a
                                            class="azeroth-menu-item-title" title="Camera" href="#"><span class="icon flaticon-technology"></span>Camera</a></li>
                                    <li id="menu-item-895"
